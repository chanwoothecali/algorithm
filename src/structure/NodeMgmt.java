...
public class NodeMgmt {
    ...
    public boolean insertNode(int data) {
        ...
        // CASE1: structure.Node 가 하나도 없을 때
        if (this.head == null) {
            this.head = new Node(data);
        } else {
            // CASE2: structure.Node 가 하나라도 들어가 있을 때
            Node findNode = this.head;
            while (true) {

                // CASE2-1: 현재 structure.Node 의 왼쪽에 data 가 들어가야 할 때
                if (data < findNode.value) {
                    ...
                    // CASE2-2: 현재 structure.Node 의 오른쪽에 data 가 들어가야 할 때
                } else {
    ...
    public boolean delete(int value) {
        ...
        // structure.Node 가 하나라도 들어가 있을 때
        Node currParentNode = this.head;
        Node currNode = this.head;

        // 코너 케이스1: structure.Node 가 하나도 없을 때
        if (this.head == null) {
            return false;
        } else {
            // 코너 케이스2: (structure.Node 가 단지 하나이고, 해당 structure.Node 삭제 시)
        ...
        if (currNode.left == null && currNode.right == null) {
            ...
            // 삭제할 Node가 Parent structure.Node 왼쪽에 있을 때
            if (value < currParentNode.value) {

                // 삭제할 Node의 오른쪽 자식 중, 가장 작은 값을 가진 structure.Node 찾기
                ...
                // 여기까지 실행되면, changeNode 에는 삭제할 structure.Node 의 오른쪽 자식 중, 가장 작은 값을 가진 structure.Node 가 들어있음
                ...
                // parent structure.Node 의 왼쪽 Child structure.Node 에 삭제할 Node의 오른쪽 자식 중, 가장 작은 값을 가진 changeNode 를 연결
                currParentNode.left = changeNode;
                // parent structure.Node 왼쪽 Child structure.Node 인 changeNode 의 왼쪽/오른쪽 Child structure.Node 를
                // 모두 삭제할 currNode 의 기존 왼쪽/오른쪽 structure.Node 로 변경
                changeNode.right = currNode.right;
                changeNode.left = currNode.left;

                // 삭제할 structure.Node 삭제!
                currNode = null;
                // 삭제할 Node가 Parent structure.Node 오른쪽에 있을 때
            } else {
                // 삭제할 Node의 오른쪽 자식 중, 가장 작은 값을 가진 structure.Node 찾기
                Node changeNode = currNode.right;
                Node changeParentNode = currNode.right;
                ...
                // parent structure.Node 의 오른쪽 Child structure.Node 에 삭제할 Node의 오른쪽 자식 중, 가장 작은 값을 가진 changeNode 를 연결
